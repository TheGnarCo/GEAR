...
describe "Viewing user" do
  ...
  it "displays a list of all of the given users assets" do
    ...
    asset_1 = create(:employee_asset, user:, model_number: "00001")
    asset_2 = create(:employee_asset, user:, model_number: "00002")

    other_user = create(:user, first_name: "Brett Hartley", last_name: "Jarvis",
      email: "badboy@example.com")
    other_asset_1 = create(:employee_asset, user: other_user, model_number: "x0001")
    other_asset_2 = create(:employee_asset, user: other_user, model_number: "x0002")
